...
def chat_completion_v1(request, body: SensetimeChatCompletionBody):
    ...
    msgs.append(msg_item)
    # restful api
    url = get_base_url(PROVIDER_SENSETIME, body.model) + "/v1/chat/completions"
    api_key = get_api_key(PROVIDER_SENSETIME, body.model)
